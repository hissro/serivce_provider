...
const kPrimaryColor = Color(0xFFd9a444);
const kPrimaryLightColor = Color(0xFFf4f4eb);
const kSecondaryColor = Color(0xFFf1d826);
const kTextLightColor = Color(0xFF9A9BB2);
const GrayColor = Color(0xFF9A9BB2);
...
var ErrorColor = Colors.red.withOpacity(0.4);
...
class Constants
{
  static String Noura = "noura";
  static String Bein = "main";
  ...
  static String SLIDER_DESC = "  سواء كنت طالبًا أو خريجًا جديدًا أو حتى موظفاُ وتبحث عن تغيير أو شيء ما لمساعدتك في بناء مهنة في مجال عمل جديد، التطوع هو مفتاح كل هذا فالتطوع يمكنه فتح الأبواب لك ويوفر لك فرصة ويوسعك أفاقك للوصول إلى أهدافك وبناء المسار الوظيفي الذي تسعى إليه. ";
